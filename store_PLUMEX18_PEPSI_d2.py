...
## DO NOT TOUCH 
def open_datafile_write(filename='../PLUMEX18/PLUMEX18/PEPSI/d2/raw/PLUMEX18_bench.dat'):
...
if len(sys.argv)==2:
   filename=sys.argv[1]
   fid=open_datafile_write('../PLUMEX18/PLUMEX18/PEPSI/d2/raw/' +filename)
else:
...
#          print('wait')
          ...
          if line[:6]==b'$MADRE':
             #State=1
             len_header    = len(line)
             EpsiStamp     = int(line[6:6+10],16)
             TimeStamp     = int(line[17:17+10],16)
