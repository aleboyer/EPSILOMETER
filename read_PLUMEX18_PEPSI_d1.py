...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('../PLUMEX18/PLUMEX18/PEPSI/d1/raw/'+filename)
   epsifile='../PLUMEX18/PLUMEX18/PEPSI/d1/epsi/'+filename
else:
   filename='../PLUMEX18/PLUMEX18/PEPSI/d1/raw/PLUMEX18_bench.dat' 
   fid,eof=open_datafile(filename)
   epsifile='../PLUMEX18/PLUMEX18/PEPSI/d1/epsi/PLUMEX18_bench.dat'
   
if len(sys.argv)==3:
    ctdfile= '../PLUMEX18/PLUMEX18/PEPSI/d1/ctd/'+sys.argv[2]
else:
    ctdfile='../PLUMEX18/PLUMEX18/PEPSI/d1/ctd/PLUMEX18_bench.dat'
