...
## DO NOT TOUCH 
def open_datafile_write(filename='/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/raw/MADREshipping_GRANITE.dat'):
...
if len(sys.argv)==2:
   filename=sys.argv[1]
   fid=open_datafile_write('/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/raw/' +filename)
else:
