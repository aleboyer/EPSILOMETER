function Meta_Data=EPSInoTIME_MakeMatFromRaw(Meta_Data)
%
%  EPSI_MakeMatFromRaw
...
listmat=dir([epsiDIR 'epsi_raw' listraw(1).name(end-6:end-5) 'mat']);
...
if isempty(datemat)
    ...
    for f=1:length(listraw)
        ...
        [EPSI,AUX,posi]=EPSI_Readbin_noTIME(file,posi_start,Meta_Data);
