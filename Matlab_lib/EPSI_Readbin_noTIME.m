function [EPSI,AUX,posi]=EPSI_Readbin_noTIME(file,posi,Meta_Data)
   ...
   fprintf('%i blocks to process \n',N_goodMadreblock);
    ...
    for i=1:N_goodMadreblock
        ...
        [EPSI.index(i),EPSI.timestamp(i),EPSI.sderror(i),EPSI.chsum1(i),EPSI.alti(i),EPSI.chsumepsi(i),...
            ...
            EPSI.EPSIchannels(1+(i-1)*160:i*160,:)]=parsehex_epsiblock(Madreblocks{i}(index_startblock:end),Meta_Data);
