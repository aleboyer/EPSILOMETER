...
plot(ax(1),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.a1(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(1,:))
hold(ax(1),'on')
plot(ax(1),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.a2(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(2,:))
hold(ax(1),'off')

plot(ax(2),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.a3(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(3,:))

plot(ax(3),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.t1(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(4,:))
hold(ax(3),'on')
plot(ax(3),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.t2(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(5,:))
hold(ax(3),'off')

plot(ax(4),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.s1(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(6,:))
hold(ax(4),'on')
plot(ax(4),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),EPSI.s2(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(7,:))
hold(ax(4),'off')

plot(ax(5),timeaxis(floor(L/2)-325*100:floor(L/2)+325*100),dramp(floor(L/2)-325*100:floor(L/2)+325*100),'Color',cmap(8,:))
    ...
    switch Answer1
        case 'y'
            eval(['!mkdir ' Meta_Data.CALIpath])
             ...
             save(fullfile(Meta_Data.CALIpath,[Meta_Data.deployment '-FPO7_noise.mat']),'f1','n0','n1','n2','n3')
             save(fullfile(Meta_Data.CALIpath,[Meta_Data.deployment '-shear_noise.mat']),'f1','n0s','n1s','n2s','n3s')
