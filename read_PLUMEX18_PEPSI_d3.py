...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('../PLUMEX18/PLUMEX18/PEPSI/d3/raw/'+filename)
   epsifile='../PLUMEX18/PLUMEX18/PEPSI/d3/epsi/'+filename
   ctdfile= '../PLUMEX18/PLUMEX18/PEPSI/d3/ctd/'+sys.argv[1]
else:
   filename='../PLUMEX18/PLUMEX18/PEPSI/d3/raw/PLUMEX18_bench.dat' 
   fid,eof=open_datafile(filename)
   epsifile='../PLUMEX18/PLUMEX18/PEPSI/d3/epsi/PLUMEX18_bench.dat'
...
if (len(blocks[1].split(b'$AUX1'))==2):
    ...
    print(' print in '+ctdfile +'_SBE.mat')
