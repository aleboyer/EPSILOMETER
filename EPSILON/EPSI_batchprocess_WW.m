...
if ~exist([L1path 'Turbulence_Profiles.mat'],'file')
    ...
    % add pressure from ctd to the epsi profile. This should be termporary until
...
Epsilon_class=calc_binned_epsi(MS(4:end));
...
print(F1,[L1path Meta_Data.deployement '_binned_epsilon1_t3s_newSV.png'],'-dpng2')
print(F2,[L1path Meta_Data.deployement '_binned_epsilon2_t3s._newSVpng'],'-dpng2')
...
save([L1path  'Turbulence_grid.mat'],'Map_epsilon1','Map_epsilon2','Map_time','zaxis')
