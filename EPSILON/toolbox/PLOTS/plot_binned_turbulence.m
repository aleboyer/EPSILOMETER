function plot_binned_turbulence(Meta_Data)
...
print(F1,fullfile(Meta_Data.L1path,[Meta_Data.deployment '_binned_chi22_c_t3s.png']),'-dpng2')
print(F2,fullfile(Meta_Data.L1path,[Meta_Data.deployment '_binned_chi21_c_t3s.png']),'-dpng2')
