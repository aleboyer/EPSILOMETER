function mod_epsilometer_batch_process(Meta_Data,profileIdx)
...
for i = profileIdx
    ...
    Profile = mod_epsilometer_calc_turbulence(Meta_Data,Profile);
    ...
    % Save with unique Profile name
    eval(sprintf('Profile%03i = Profile;',i))
    clear Profile;
    save_var_name = sprintf('Profile%03i',i);
