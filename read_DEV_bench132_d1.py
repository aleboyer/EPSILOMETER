...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('/Volumes/KINGSTON//DEV/bench132/d1/raw/'+filename)
   epsifile='/Volumes/KINGSTON//DEV/bench132/d1/epsi/'+filename
else:
   filename='/Volumes/KINGSTON//DEV/bench132/d1/raw/bench132_d1.dat' 
   fid,eof=open_datafile(filename)
   epsifile='/Volumes/KINGSTON//DEV/bench132/d1/epsi/bench132_d1.dat'
   
if len(sys.argv)==3:
    ctdfile= '/Volumes/KINGSTON//DEV/bench132/d1/ctd/'+sys.argv[2]
else:
    ctdfile='/Volumes/KINGSTON//DEV/bench132/d1/ctd/bench132_d1.dat'
