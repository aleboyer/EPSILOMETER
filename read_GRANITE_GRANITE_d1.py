...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/raw/'+filename)
   epsifile='/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/epsi/'+filename
else:
   filename='/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/raw/MADREshipping_GRANITE.dat' 
   fid,eof=open_datafile(filename)
   epsifile='/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/epsi/MADREshipping_GRANITE.dat'
   
if len(sys.argv)==3:
    ctdfile= '/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/ctd/'+sys.argv[2]
else:
    ctdfile='/Users/aleboyer/ARNAUD/SCRIPPS/SHEAR_PROBE//GRANITE/GRANITE/d1/ctd/MADREshipping_GRANITE.dat'
