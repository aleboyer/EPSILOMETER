...
if len(sys.argv)>=2:
   ...
   filename='ep_test_20170101_000000_1.dat'   

fid,eof   = open_datafile('/Users/Shared/EPSILOMETER//NISKINE/epsifish1/d5/raw/'+ filename)
epsifile ='/Users/Shared/EPSILOMETER//NISKINE/epsifish1/d5/epsi/'+'epsi_'+filename
ctdfile  = '/Users/Shared/EPSILOMETER//NISKINE/epsifish1/d5/ctd/'+'ctd_'+filename
