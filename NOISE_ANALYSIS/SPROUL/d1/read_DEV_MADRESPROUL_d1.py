...
if len(sys.argv)>=2:
   ...
   epsifile='/Volumes/KINGSTON/DEV/MADRESPROUL/d1/epsi/'+filename
else:
   filename='/Volumes/KINGSTON/DEV/MADRESPROUL/d1/raw/MADREtest.dat' 
   fid,eof=open_datafile(filename)
   epsifile='/Volumes/KINGSTON/DEV/MADRESPROUL/d1/epsi/MADREtest.dat'
   
if len(sys.argv)==3:
    ctdfile= '/Volumes/KINGSTON/DEV/MADRESPROUL/d1/ctd/'+sys.argv[2]
else:
    ctdfile='/Volumes/KINGSTON/DEV/MADRESPROUL/d1/ctd/MADREtest.dat'
