...
## DO NOT TOUCH 
def open_datafile_write(filename='/Volumes/KINGSTON/DEV/MADRESPROUL/d1/raw/MADREtest.dat'):
...
if len(sys.argv)==2:
   filename=sys.argv[1]
   fid=open_datafile_write('/Volumes/KINGSTON/DEV/MADRESPROUL/d1/raw/' +filename)
else:
