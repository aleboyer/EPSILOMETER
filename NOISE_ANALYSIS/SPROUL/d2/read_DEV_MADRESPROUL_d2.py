...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('/Volumes/KINGSTON/DEV/MADRESPROUL/d2/raw/'+filename)
   epsifile='/Volumes/KINGSTON/DEV/MADRESPROUL/d2/epsi/'+filename
else:
   filename='/Volumes/KINGSTON/DEV/MADRESPROUL/d2/raw/MADREtest.dat' 
   fid,eof=open_datafile(filename)
   epsifile='/Volumes/KINGSTON/DEV/MADRESPROUL/d2/epsi/MADREtest.dat'
   
if len(sys.argv)==3:
    ctdfile= '/Volumes/KINGSTON/DEV/MADRESPROUL/d2/ctd/'+sys.argv[2]
else:
    ctdfile='/Volumes/KINGSTON/DEV/MADRESPROUL/d2/ctd/MADREtest.dat'
