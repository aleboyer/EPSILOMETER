...
if len(sys.argv)>=2:
   filename=sys.argv[1]
   fid,eof=open_datafile('/Volumes/KINGSTON/DEV/GRANITE/d1/raw/'+filename)
   epsifile='/Volumes/KINGSTON/DEV/GRANITE/d1/epsi/'+filename
else:
   filename='/Volumes/KINGSTON/DEV/GRANITE/d1/raw/MADREshipping_GRANITE.dat' 
   fid,eof=open_datafile(filename)
   epsifile='/Volumes/KINGSTON/DEV/GRANITE/d1/epsi/MADREshipping_GRANITE.dat'
   
if len(sys.argv)==3:
    ctdfile= '/Volumes/KINGSTON/DEV/GRANITE/d1/ctd/'+sys.argv[2]
else:
    ctdfile='/Volumes/KINGSTON/DEV/GRANITE/d1/ctd/MADREshipping_GRANITE.dat'
